        ...
        <div className="section">
          ...
          <div className="cards">
            {positions.tech.map((item) => (
              <Card key={item.title} title={item.title} body={item.body} role={item.role} formLink={item.link} isAlert={item.isAlert} />
            ))}
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="cards">
            {positions.nontech.map((item) => (
              <Card key={item.title} title={item.title} body={item.body} role={item.role} formLink={item.link} />
            ))}
          </div>
        </div>
      </div>
