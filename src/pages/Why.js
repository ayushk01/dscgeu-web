					...
					<div className="content">
						<ul>
							...
							<li>
								💠 Network
								<div className="explain">
									It provides student with an opportunity to
							...
							<li>
								💠 Career Development
								<div className="explain">
									Also encourages career development and an
									understanding of opportunities within the
									industry.
								</div>
							</li>
							<li>
								...
								<div className="explain">
									...
									receive information and resources that will
									support their future interest goals
								</div>
							</li>
							<li>
								...
								<div className="explain">
									...
									technologies, meet-ups with different people
								</div>
							</li>
							<li>
								💠 Mentor Support
								<div className="explain">
									...
									connected with us to guide throughout your
									journey
								</div>
							</li>
						</ul>
